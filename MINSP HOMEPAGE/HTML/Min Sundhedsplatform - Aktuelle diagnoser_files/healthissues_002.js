(function() {var template = Handlebars.template, templates = $$WP.Templates = $$WP.Templates || {};templates = templates.Clinical = templates.Clinical || {};templates['HealthIssues'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper;

  return container.escapeExpression((helpers.setStringNamespace || (depth0 && depth0.setStringNamespace) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),"Clinical.HealthIssues",{"name":"setStringNamespace","hash":{},"data":data}))
    + "<div class=\"healthissuecontainer\">"
  ...
  return "<div class=\"card clinicalcard healthissuecard withButton\" data-index=\""
  ...
  return "<div class=\"card addItem noprint\"><a data-id=\"additem\" href=\"#\" aria-label=\""
    ...
    + "\"><span class=\"vcenter\" aria-hidden=\"true\"><span class=\"addlabel\">"
    + container.escapeExpression(((helper = (helper = helpers.addbuttonlabel || (depth0 != null ? depth0.addbuttonlabel : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"addbuttonlabel","hash":{},"data":data}) : helper)))
    + "</span></span></a></div>";
